...
type DataInput = Record<string, any>[] | Record<string, any>;

export function formatOutput(data: DataInput, format: OutputFormat): string {
...
export function printOutput(data: DataInput, format: OutputFormat): void {
